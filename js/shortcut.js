...
shortcut = {
	...
	'add':function(shortcut_combination,callback,opt) {
		...
		var default_options = {
			...
			'require_command_mode':false,		// I'm curious what command mode is?  Just another setting to prevent triggers?  I changed it.
			'target':document,
			'keycode':false
		}
		...
		var func = function(e) {
			...
			var special_keys = {
				...
				// this is the right-click menu-invoking key towards the bottom right
